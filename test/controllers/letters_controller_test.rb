...
class LettersControllerTest < ActionController::TestCase
  ...
  test "should create letter" do
    assert_difference('Letter.count') do
      post :create, letter: { candidates: @letter.candidates, current: @letter.current, experience: @letter.experience, industry: @letter.industry }
    end
  ...
  test "should update letter" do
    patch :update, id: @letter, letter: { candidates: @letter.candidates, current: @letter.current, experience: @letter.experience, industry: @letter.industry }
    assert_redirected_to letter_path(assigns(:letter))
  end
